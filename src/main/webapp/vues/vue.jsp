...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" name="productName"value="${product.nom}">
  </div>
  <div class="form-group">
...
<c:if test="${books.id==null}">add</c:if>
<c:if test="${books.id!==null}">edit</c:if>
</button>
</form>
</body>
</html>